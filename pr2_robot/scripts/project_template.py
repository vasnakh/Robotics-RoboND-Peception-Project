...
# Exercise-2 TODOs:
    ...
    filter_axis = 'z'
    passthrough1.set_filter_field_name(filter_axis)
    axis_min = 0.6
    axis_max = 1.4
...
def pr2_mover(object_list):
    ...
    for i in range(len(object_list_param)):
        ...
        for object in object_list:
            if (object.label == object_name):
                ...
                yaml_dict = make_yaml_dict(test_scene_num, arm_name, object_name_msg, pick_pose, place_pose)
                ...
                #     resp = pick_place_routine(test_scene_num, object_name_msg, arm_name, pick_pose, place_pose)
                #
    ...
    out_file = 'output_' + str(scene_number) + ".yaml"
